...
const ProductDetail = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black text-yellow-200 px-6 md:px-20 py-28 font-sans overflow-hidden">
      {/* Background Video */}
      {product.videoUrl && (
        <video
          autoPlay
      ...
      {/* Content Container */}
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row gap-12 items-start bg-gradient-to-br from-[#1a1a1a]/80 to-black/80 p-10 rounded-3xl border border-yellow-500 shadow-[0_0_60px_rgba(255,215,0,0.3)]">
        {/* Golden Glow Effects */}
