      ...
      {!isOpen && (
        <>
          ...
          <motion.div
            ...
            style={{
              background: 'linear-gradient(to left, #0f0f0f, #1a0000)',
...
const Tee = ({ src, alt, index, isVisible, total }) => {
  const rotationY = (index - (total - 1) / 2) * 3;
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-t from-red-500/20 to-transparent blur-sm translate-y-2 rounded-lg" />
        <img
          src={src}
          alt={alt}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <motion.h1
          className="text-6xl font-bold text-center mb-16 bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent"
